-- Create a SECURITY DEFINER function to set up new user organization
-- This bypasses RLS securely during the signup flow
...
BEGIN
  ...
  INSERT INTO public.billing_config (organization_id, plan_tier, trial_ends_at, subscription_status, client_limit)
  VALUES (_org_id, 'trial', _trial_ends_at, 'trialing', 1);
...
GRANT EXECUTE ON FUNCTION public.setup_new_user_organization(uuid, text, text) TO authenticated;
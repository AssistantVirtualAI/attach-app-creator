...
const dark: ThemeTokens = {
  ...
  bg: '#05060d',
  bgGradient:
    'radial-gradient(1400px 700px at 8% -12%, rgba(35,214,255,0.16), transparent 60%), radial-gradient(900px 600px at 108% 110%, rgba(124,76,255,0.14), transparent 55%), linear-gradient(180deg, #05060d 0%, #07091a 100%)',
  surface: 'rgba(255,255,255,0.04)',
  surfaceElev: 'rgba(255,255,255,0.06)',
  surfaceHover: 'rgba(35,214,255,0.08)',
  border: 'rgba(140,180,255,0.10)',
  borderStrong: 'rgba(140,180,255,0.22)',
  text: '#eaf4ff',
  textMuted: 'rgba(234,244,255,0.62)',
  textSubtle: 'rgba(234,244,255,0.38)',
  accent: '#23d6ff',
  accentSoft: 'rgba(35,214,255,0.14)',
  accentGradient: 'linear-gradient(135deg, #23d6ff 0%, #7a4cff 60%, #ec4899 100%)',
  accentGlow: '0 10px 36px -10px rgba(35,214,255,0.55)',
  success: '#22d39a',
  danger: '#ff5577',
  warning: '#ffb84a',
  ringGlow: '0 0 0 3px rgba(35,214,255,0.22)',

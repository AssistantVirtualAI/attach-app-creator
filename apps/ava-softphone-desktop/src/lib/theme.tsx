...
export const theme = {
  colors: {
    // Elevated navy palette — modern, elegant, more blue/gold, less near-black
    bg: '#0A1530',
    bgGradient:
      'radial-gradient(1100px 700px at 12% -10%, rgba(0,82,204,0.22), transparent 60%), radial-gradient(900px 600px at 100% 110%, rgba(255,215,0,0.10), transparent 55%), linear-gradient(180deg, #0A1530 0%, #0E1B3D 100%)',
    bgCard: '#152547',
    bgCardHover: '#1B2E55',
    bgElev: '#1B2E55',
    border: 'rgba(140,180,255,0.10)',
    borderGold: 'rgba(255,215,0,0.32)',
    borderAI: 'rgba(124,58,237,0.4)',
    primary: '#0052CC',
    primaryLight: '#2D7BE5',
    gold: '#FFD700',
    goldSoft: '#F0C75A',
    goldDim: 'rgba(255,215,0,0.18)',
    ai: '#7C3AED',
    aiLight: '#9D6FF0',
    ...
    text: '#EAF2FF',
    textSub: '#9FB3D6',
    textDim: 'rgba(234,242,255,0.40)',
    // Console tokens — lifted navy
    midnight: '#0A1530',
    deepPanel: '#0E1B3D',
    graphite: '#152547',
    lemtelBlue: '#0052CC',
